...
class JazzerBot{
  ...
  static final SplashScreen splash = SplashScreen.getSplashScreen();
        ...
        JOptionPane.showMessageDialog(null,"You will now be asked to supply parameters for one section" + "\n"
         ...
         // mididevice1 = scan.nextInt();
          ...
          if(yno==JOptionPane.YES_OPTION){
            ...
            JOptionPane.showMessageDialog(null,"Your file may now be found in the same" + "\n" + "directory in which JazzerBot is located.", "Saved", JOptionPane.PLAIN_MESSAGE, logo);
    ...
    public static void main2()
        ...
        while(filename == null || filename.equals("")){
             filename = JOptionPane.showInputDialog(null,
             "Please input the desired filename.  If the file"+"\n"+"is a .midi file, please use that extension.","Filename",JOptionPane.QUESTION_MESSAGE);
         }
         if(filename.endsWith(".mid")||filename.endsWith(".midi")){
              filename=filename;
         }else{
